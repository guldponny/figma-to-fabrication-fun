...
export const SettingsDrawer: React.FC = () => {
  ...
  return (
    <aside className="min-w-[40px] transition-all duration-200">
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        <CollapsibleTrigger className="flex items-center justify-center w-10 h-10 hover:bg-accent rounded-lg">
          <ChevronDown className={`w-6 h-6 transition-transform duration-200 ${isOpen ? "" : "-rotate-90"}`} />
        </CollapsibleTrigger>
        
        <CollapsibleContent className="w-[252px]">
              ...
              <div className="flex w-full gap-2 pl-6 pr-4 pt-6 pb-3 max-md:pl-5">
                <div className="flex w-full gap-2 flex-1 shrink basis-[0%]">
                  ...
                  <button 
                    ...
                    className="justify-center items-center flex w-6 h-6 pr-[var(--Horizontal-XXS,] pl-[}] pt-[2px)] pb-[2px;] rounded-[4px)_4px_4px_4p]"
                  >
                    <img
